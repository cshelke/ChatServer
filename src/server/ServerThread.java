...
public class ServerThread extends Thread {
	...
	public void send(String msg) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
	...
	public void run() {
		...
		try {
			...
			while (true) {
				int retVal = server.checkForDups(ID,
						SecurityHandlerServer.decryptTheMessage(streamIn.readUTF(), server.getKey()));
				...
				| IllegalBlockSizeException | BadPaddingException ioe) {
