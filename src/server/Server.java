...
public class Server implements Runnable {
	...
	// constructor
	public Server(int port) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException,
	...
	public synchronized void handle(int ID, String inputString) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
		...
		else if (input.equals("/rooms")) // print all the available chatrooms
											// and their sizes
		{
